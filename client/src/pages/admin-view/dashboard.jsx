              ...
              <BarChart data={mostSellingItems}>
                ...
                <Tooltip
                  formatter={(value, name, props) => [
                    value,
                    props.payload.name, // show item name in tooltip
                  ]}
                />
                <Bar
                  dataKey="quantity"
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Track how your total revenue changes over the selected period, and
